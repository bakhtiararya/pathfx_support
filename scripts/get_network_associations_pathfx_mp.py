### PathFX version created: pathfx_mp
...
genes_to_cuis = pickle.load(open('../rscs/pathfx_mp_merged_genes_to_cuis.pkl','rb'))
sourced_phens = pickle.load(open('../rscs/pathfx_mp_sourced_phens.pkl','rb'))
expect_pvals = pickle.load(open('../results/pathfx_mprandom_networks/pathfx_mp_expected_pvalue_summary.pkl','rb'))
phen_to_cui = pickle.load(open('../rscs/pathfx_mp_all_phens_to_cuis.pkl','rb'))
intome_size = pickle.load(open('../rscs/pathfx_mp_intome_size.pkl','rb'))
cui_to_phens = pickle.load(open('../rscs/pathfx_mp_cui_to_phens.pkl','rb'))
cui_to_genes = pickle.load(open('../rscs/pathfx_mp_merged_unique_cuis2genes.pkl','rb'))
