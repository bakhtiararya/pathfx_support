...
dup_name = 'pfxapp_july19'

#########################################################################
### 0.1 Merge interactions with scores, pickle network file
int_fname = '/Users/jenwilson/Documents/Stanford_CERSI/IntegratorCode/pathfx_data_update/data/scored_interactome_data.txt'
...
cmd = "python push_new_data_to_pathfx.py -drug_targets %s -drugname_to_DBid %s -gene_hash %s -sum_hash %s -unique_nodes %s -update_name %s"%s(VAR1, VAR2, VAR3, VAR4, VAR5, dup_name)
